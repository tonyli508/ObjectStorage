Pod::Spec.new do |s|
  ...
  s.version = '0.1'
  s.license = 'MIT'
  s.summary = 'ObjectStorage is a framework that make CURD works on your model entities, you may choose what storage you want e.g. Sqlite, CoreData, plist...'
  ...
  s.requires_arc = 'true'
  s.source_files = 'ObjectStorage/ObjectStorage/*.swift'
end
